...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(` ${ssrInterpolate(unref(loading) ? "Ingresando..." : "Iniciar sesión")}</button></form></div><p class="mt-6 text-center text-xs text-slate-custom/60">Acceso restringido a administradores autorizados</p></div></div>`);
    };
  }
});
...
//# sourceMappingURL=login-BgSRMwi_.js.map
