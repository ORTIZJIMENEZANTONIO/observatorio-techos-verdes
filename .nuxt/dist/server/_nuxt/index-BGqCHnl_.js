...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  `;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="border-b border-accent/20 bg-accent/5 px-4 py-2"><div class="flex items-center gap-2 text-xs text-accent-dark"><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="12"></line><line x1="12" y1="16" x2="12.01" y2="16"></line></svg><span>Aptitud territorial, no factibilidad estructural. Consulte dictámenes técnicos para implementación.</span></div></div><div class="relative flex flex-1 overflow-hidden"><aside class="${ssrRenderClass([
      ...
      _push(`<!--]--></div></div><div class="mt-5"><label class="text-xs font-semibold uppercase tracking-wider text-slate-custom">Alcaldía</label><select class="select mt-1.5"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(filterAlcaldia)) ? ssrLooseContain(unref(filterAlcaldia), "") : ssrLooseEqual(unref(filterAlcaldia), "")) ? " selected" : ""}>Todas las alcaldías</option><!--[-->`);
      ...
      if (unref(activeLayer) === "aptitud") {
        _push(`<div class="mt-4"><label class="text-xs font-semibold uppercase tracking-wider text-slate-custom">Capa ambiental</label><select class="select mt-1.5"><option value=""${ssrIncludeBooleanAttr(Array.isArray(unref(capaAmbiental)) ? ssrLooseContain(unref(capaAmbiental), "") : ssrLooseEqual(unref(capaAmbiental), "")) ? " selected" : ""}>Aptitud general (score)</option><optgroup label="Indicadores bióticos"><option value="indiceBiodiversidad"${ssrIncludeBooleanAttr(Array.isArray(unref(capaAmbiental)) ? ssrLooseContain(unref(capaAmbiental), "indiceBiodiversidad") : ssrLooseEqual(unref(capaAmbiental), "indiceBiodiversidad")) ? " selected" : ""}>Índice de biodiversidad</option><option value="coberturaVegetal"${ssrIncludeBooleanAttr(Array.isArray(unref(capaAmbiental)) ? ssrLooseContain(unref(capaAmbiental), "coberturaVegetal") : ssrLooseEqual(unref(capaAmbiental), "coberturaVegetal")) ? " selected" : ""}>Cobertura vegetal</option><option value="riquezaEspecies"${ssrIncludeBooleanAttr(Array.isArray(unref(capaAmbiental)) ? ssrLooseContain(unref(capaAmbiental), "riquezaEspecies") : ssrLooseEqual(unref(capaAmbiental), "riquezaEspecies")) ? " selected" : ""}>Riqueza de especies</option><option value="indiceShannonWiener"${ssrIncludeBooleanAttr(Array.isArray(unref(capaAmbiental)) ? ssrLooseContain(unref(capaAmbiental), "indiceShannonWiener") : ssrLooseEqual(unref(capaAmbiental), "indiceShannonWiener")) ? " selected" : ""}>Shannon H&#39;</option><option value="indiceSimpson"${ssrIncludeBooleanAttr(Array.isArray(unref(capaAmbiental)) ? ssrLooseContain(unref(capaAmbiental), "indiceSimpson") : ssrLooseEqual(unref(capaAmbiental), "indiceSimpson")) ? " selected" : ""}>Simpson 1-D</option></optgroup><optgroup label="Indicadores hídricos"><option value="captacionPluvial"${ssrIncludeBooleanAttr(Array.isArray(unref(capaAmbiental)) ? ssrLooseContain(unref(capaAmbiental), "captacionPluvial") : ssrLooseEqual(unref(capaAmbiental), "captacionPluvial")) ? " selected" : ""}>Captación pluvial</option><option value="precipitacionMediaAnual"${ssrIncludeBooleanAttr(Array.isArray(unref(capaAmbiental)) ? ssrLooseContain(unref(capaAmbiental), "precipitacionMediaAnual") : ssrLooseEqual(unref(capaAmbiental), "precipitacionMediaAnual")) ? " selected" : ""}>Precipitación media anual</option><option value="eficienciaRetencion"${ssrIncludeBooleanAttr(Array.isArray(unref(capaAmbiental)) ? ssrLooseContain(unref(capaAmbiental), "eficienciaRetencion") : ssrLooseEqual(unref(capaAmbiental), "eficienciaRetencion")) ? " selected" : ""}>Eficiencia de retención</option><option value="escorrentiaEvitada"${ssrIncludeBooleanAttr(Array.isArray(unref(capaAmbiental)) ? ssrLooseContain(unref(capaAmbiental), "escorrentiaEvitada") : ssrLooseEqual(unref(capaAmbiental), "escorrentiaEvitada")) ? " selected" : ""}>Escorrentía evitada</option></optgroup></select></div>`);
      } else {
        _push(`<!---->`);
      }
      ...
      if (unref(activeLayer) === "existentes") {
        _push(`<div class="flex items-center justify-between"><span class="text-sm text-ink">Superficie total</span><span class="text-sm font-bold text-primary">${ssrInterpolate(unref(totalArea).toLocaleString())} m²</span></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(activeLayer) === "candidatos") {
...
//# sourceMappingURL=index-BGqCHnl_.js.map
