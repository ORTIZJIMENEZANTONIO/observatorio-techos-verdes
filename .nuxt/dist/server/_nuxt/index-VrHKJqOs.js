  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Conocer metodología `);
          } else {
            return [
              createTextVNode(" Conocer metodología ")
            ];
          }
        }),
        _: 1
      ...
      _push(`</div><div class="relative min-h-[300px] overflow-hidden lg:min-h-[400px]" data-v-7083ebfb><img${ssrRenderAttr("src", _imports_0)} alt="Mapa inventario de techos verdes en la Ciudad de México, elaborado a partir de investigación de campo y datos georreferenciados" class="absolute inset-0 h-full w-full object-cover" data-v-7083ebfb><div class="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/60 to-transparent p-4" data-v-7083ebfb><p class="text-xs text-white/90" data-v-7083ebfb>Inventario georreferenciado de techos verdes en la CDMX</p><p class="text-[10px] text-white/60" data-v-7083ebfb>Fuente: Cervantes Nájera (2025), CIIEMAD-IPN</p></div></div></div></div></div></section><section class="bg-white py-16" data-v-7083ebfb><div class="container-wide" data-v-7083ebfb><div class="grid grid-cols-1 items-center gap-12 lg:grid-cols-2" data-v-7083ebfb><div class="reveal-left" data-v-7083ebfb>`);
      _push(ssrRenderComponent(_component_CommonSectionTitle, {
      ...
      _push(`<p class="text-sm leading-relaxed text-slate-custom" data-v-7083ebfb> Un techo verde es un sistema constructivo que integra vegetación viva sobre las cubiertas de los edificios. Se compone de múltiples capas: impermeabilizante, barrera anti-raíz, capa drenante, sustrato y la capa de vegetación. Los techos verdes extensivos, como el TVLE desarrollado en el CIIEMAD-IPN, utilizan materiales orgánicos residuales (paja y fibra de coco) en su capa drenante, reduciendo costos y huella de carbono. </p><div class="mt-6 grid grid-cols-2 gap-3" data-v-7083ebfb><div class="rounded-lg bg-primary-50 p-3 text-center" data-v-7083ebfb><span class="text-2xl font-bold text-primary" data-v-7083ebfb>94.8%</span><p class="mt-1 text-[10px] font-medium uppercase tracking-wider text-primary/70" data-v-7083ebfb>Menos huella de carbono vs convencional</p></div><div class="rounded-lg bg-eco/10 p-3 text-center" data-v-7083ebfb><span class="text-2xl font-bold text-eco-dark" data-v-7083ebfb>25.9%</span><p class="mt-1 text-[10px] font-medium uppercase tracking-wider text-eco-dark/70" data-v-7083ebfb>Más económico que el convencional</p></div></div></div><div class="reveal-right" data-v-7083ebfb><div class="overflow-hidden rounded-card bg-surface shadow-card" data-v-7083ebfb><img${ssrRenderAttr("src", _imports_1)} alt="Diagrama de las capas de un techo verde: vegetación, sustrato, drenante, barrera anti-raíz, impermeabilizante y base del techo" class="mx-auto w-full max-w-sm p-6" data-v-7083ebfb><div class="border-t border-gray-100 px-4 py-2.5" data-v-7083ebfb><p class="text-[10px] text-slate-custom" data-v-7083ebfb>Imagen 2. Capas de un techo verde. Fuente: Cervantes Nájera (2021), CIIEMAD-IPN</p></div></div></div></div></div></section><section class="bg-surface py-16" data-v-7083ebfb><div class="container-wide" data-v-7083ebfb>`);
      _push(ssrRenderComponent(_component_CommonSectionTitle, {
      ...
      ssrRenderList(unref(featuredRoofs), (roof, index2) => {
        ...
        ])}" data-v-7083ebfb>${ssrInterpolate(roof.estado)}</span></div><h4 class="text-base font-semibold text-ink" data-v-7083ebfb>${ssrInterpolate(roof.nombre)}</h4><p class="mt-1 text-xs text-slate-custom" data-v-7083ebfb>${ssrInterpolate(roof.alcaldia)} · ${ssrInterpolate(roof.superficie?.toLocaleString())} m2</p><p class="mt-2 text-sm leading-relaxed text-slate-custom line-clamp-2" data-v-7083ebfb>${ssrInterpolate(roof.notas || roof.direccion)}</p></div></div>`);
      });
      ...
      _push(`</div></div></section><section class="bg-white py-16" data-v-7083ebfb><div class="container-wide" data-v-7083ebfb><div class="overflow-hidden rounded-card bg-gradient-to-br from-primary-800 to-primary shadow-panel reveal-scale" data-v-7083ebfb><div class="grid grid-cols-1 lg:grid-cols-2" data-v-7083ebfb><div class="p-8 lg:p-12" data-v-7083ebfb><span class="mb-3 inline-flex items-center gap-2 rounded-badge bg-white/10 px-3 py-1 text-xs font-semibold uppercase tracking-wider text-accent backdrop-blur-sm" data-v-7083ebfb> Inteligencia Artificial </span><h2 class="mt-4 text-2xl font-bold text-white md:text-3xl" data-v-7083ebfb>Validación asistida por IA</h2><p class="mt-4 text-base leading-relaxed text-white/75" data-v-7083ebfb> Utilizamos modelos de visión por computadora para detectar y clasificar techos verdes a partir de imágenes aéreas y satelitales. El sistema humano-en-el-bucle garantiza la calidad de las validaciones. </p><ul class="mt-6 space-y-3" data-v-7083ebfb><!--[-->`);
...
//# sourceMappingURL=index-VrHKJqOs.js.map
