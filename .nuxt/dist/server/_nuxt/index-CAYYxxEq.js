...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function toggleVisible(row) {
      validationStore.updateRecord(row.id, { visible: !(row.visible ?? true) });
    }
...
//# sourceMappingURL=index-CAYYxxEq.js.map
