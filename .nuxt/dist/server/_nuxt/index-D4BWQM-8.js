...
import { _ as _sfc_main$2 } from "./DataDisclaimer-Bsqs480u.js";
import { ref, defineComponent, computed, mergeProps, unref, useSSRContext, watch, withCtx, createVNode, isRef } from "vue";
import { ssrRenderAttrs, ssrRenderClass, ssrRenderAttr, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderList, ssrInterpolate, ssrRenderStyle, ssrRenderComponent } from "vue/server-renderer";
import { b as useRuntimeConfig, u as useHead, _ as _export_sfc } from "../server.mjs";
import { u as useValidationStore } from "./validation-Cx4h-EgG.js";
import { _ as _sfc_main$3 } from "./DataSourceBadge-Dtt3IyCj.js";
import { _ as _sfc_main$4 } from "./PaginationControls-BAcytpD9.js";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!unref(previewUrl)) {
        ...
        _push(`<!--]--></select></div><div><label class="mb-1 block text-xs font-medium text-slate-custom">Superficie aprox. (m²)</label><input${ssrRenderAttr("value", unref(superficie))} type="number" class="input" placeholder="500" min="0"></div></div><button class="btn-primary w-full"${ssrIncludeBooleanAttr(unref(analyzing)) ? " disabled" : ""}>`);
        if (unref(analyzing)) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_CommonHeroSection, { compact: "" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1 class="text-3xl font-extrabold text-white md:text-4xl" data-v-ca29a2cf${_scopeId}>Validación asistida por IA</h1><p class="mt-2 text-base text-white/80" data-v-ca29a2cf${_scopeId}>Revisión y validación de detecciones de techos verdes</p>`);
          } else {
            return [
              createVNode("h1", { class: "text-3xl font-extrabold text-white md:text-4xl" }, "Validación asistida por IA"),
              createVNode("p", { class: "mt-2 text-base text-white/80" }, "Revisión y validación de detecciones de techos verdes")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=index-D4BWQM-8.js.map
