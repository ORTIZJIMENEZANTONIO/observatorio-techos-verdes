...
function computeRiskProfile(input) {
  ...
  indicadores.push({
    ...
    unidad: "\xB0C",
    nivel: lstNivel,
    umbralRef: `Cr\xEDtico \u2265${UMBRALES_RIESGO.lst.critico}\xB0C`
  });
  ...
  indicadores.push({
    nombre: "Vulnerabilidad h\xEDdrica",
    valor: input.captacionPluvial,
    unidad: "L/m\xB2/a\xF1o",
    nivel: hidNivel,
    umbralRef: "Ref: 20 L/m\xB2/a\xF1o"
  });
...
function computeScorePrefactibilidad(input) {
  ...
  if (zonaSismica < 50) factoresRiesgo.push("Zona s\xEDsmica de alto riesgo");
  ...
  if (edad > UMBRALES_ESTRUCTURALES.edadMaxSinRefuerzo)
    factoresRiesgo.push(`Construcci\xF3n de ${edad} a\xF1os (>50 requiere evaluaci\xF3n)`);
  ...
  if (input.niveles > UMBRALES_ESTRUCTURALES.nivelesMaxSinAnalisis)
    factoresRiesgo.push(`${input.niveles} niveles \u2014 requiere an\xE1lisis de carga`);
  ...
  if (input.estadoEstructural === "dano_mayor")
    factoresRiesgo.push("Dictamen post-sismo: da\xF1o mayor");
...
export { COSTOS_REFERENCIA as C, TASAS as T, computeRiskProfileWithStructural as a, computeCostOfInaction as b, computeScorePrefactibilidad as c, computeEffectiveM2 as d, computeROI as e, correlationMatrix as f, computeIndiceNecesidad as g, linearRegression as l };
//# sourceMappingURL=useStatisticalAnalysis-Cht9jiYj.mjs.map
