...
import { _ as _sfc_main$1 } from './DataDisclaimer-Bsqs480u.mjs';
import { _ as _sfc_main$2 } from './DataSourceBadge-Dtt3IyCj.mjs';
import { _ as _sfc_main$3 } from './PaginationControls-BAcytpD9.mjs';
...
import { u as useRoofsStore } from './roofs-DoyVCM_d.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_CommonHeroSection, { compact: "" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1 class="text-3xl font-extrabold text-white md:text-4xl"${_scopeId}>Techos candidatos priorizados</h1><p class="mt-2 text-base text-white/80"${_scopeId}>60 sitios identificados para potencial intervenci\xF3n verde</p>`);
          } else {
            return [
              createVNode("h1", { class: "text-3xl font-extrabold text-white md:text-4xl" }, "Techos candidatos priorizados"),
              createVNode("p", { class: "mt-2 text-base text-white/80" }, "60 sitios identificados para potencial intervenci\xF3n verde")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=index-CtEnMSY9.mjs.map
