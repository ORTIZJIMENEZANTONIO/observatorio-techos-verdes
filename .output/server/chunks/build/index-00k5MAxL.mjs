...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function toggleVisible(row) {
      var _a;
      const newVal = !((_a = row.visible) != null ? _a : true);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_AdminDataTable, {
        ...
        "cell-visible": withCtx(({ row }, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<button class="${ssrRenderClass([((_a = row.visible) != null ? _a : true) ? "text-eco hover:bg-eco/10" : "text-gray-300 hover:bg-gray-100", "mx-auto flex h-7 w-7 items-center justify-center rounded-lg transition-colors"])}"${ssrRenderAttr("title", ((_b = row.visible) != null ? _b : true) ? "Visible \u2014 clic para ocultar" : "Oculto \u2014 clic para mostrar")}${_scopeId}>`);
            if ((_c = row.visible) != null ? _c : true) {
            ...
            return [
              createVNode("button", {
                ...
                class: ["mx-auto flex h-7 w-7 items-center justify-center rounded-lg transition-colors", ((_d = row.visible) != null ? _d : true) ? "text-eco hover:bg-eco/10" : "text-gray-300 hover:bg-gray-100"],
                title: ((_e = row.visible) != null ? _e : true) ? "Visible \u2014 clic para ocultar" : "Oculto \u2014 clic para mostrar"
              }, [
                ((_f = row.visible) != null ? _f : true) ? (openBlock(), createBlock("svg", {
                  key: 0,
                  class: "h-4 w-4",
                  fill: "none",
                  viewBox: "0 0 24 24",
...
//# sourceMappingURL=index-00k5MAxL.mjs.map
