import { _ as __nuxt_component_0$1 } from './nuxt-link-BhPJ81xP.mjs';
import { defineComponent, mergeProps, unref, withCtx, createTextVNode, toDisplayString, ref, watch, createVNode, openBlock, createBlock, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSlot, ssrRenderList, ssrInterpolate, ssrRenderAttr, ssrRenderTeleport } from 'vue/server-renderer';
import { p as publicAssetsURL } from '../routes/renderer.mjs';
import { _ as _export_sfc, c as useRoute } from './server.mjs';
import { _ as _sfc_main$3 } from './DataDisclaimer-Bsqs480u.mjs';
import { u as useDataSource } from './useDataSource-CcCLLLin.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const navLinks = [
      ...
      { to: "/metodologia", label: "Metodolog\xEDa" }
    ];
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderTeleport(_push, (_push2) => {
        ...
        if (mobileOpen.value) {
          _push2(`<div class="fixed right-0 top-0 z-[101] flex h-full w-72 flex-col bg-white shadow-2xl lg:hidden" data-v-49616e70><div class="flex items-center justify-between border-b border-gray-100 px-4 py-4" data-v-49616e70><span class="text-sm font-bold text-ink" data-v-49616e70>Men\xFA</span><button class="flex h-9 w-9 items-center justify-center rounded-lg text-ink-muted hover:bg-gray-100" aria-label="Cerrar men\xFA" data-v-49616e70><svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-49616e70><line x1="18" y1="6" x2="6" y2="18" data-v-49616e70></line><line x1="6" y1="6" x2="18" y2="18" data-v-49616e70></line></svg></button></div><nav class="flex-1 overflow-y-auto px-3 py-4" data-v-49616e70><!--[-->`);
          ssrRenderList(navLinks, (link) => {
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></ul></div><div><h4 class="mb-4 text-xs font-semibold uppercase tracking-wider text-white/50"> Contacto e informaci\xF3n </h4><ul class="space-y-3 text-sm text-white/70"><li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" class="mt-0.5 h-4 w-4 shrink-0 text-white/40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"></path><circle cx="12" cy="10" r="3"></circle></svg><span>Ciudad de M\xE9xico, M\xE9xico</span></li><li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" class="mt-0.5 h-4 w-4 shrink-0 text-white/40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg><span>contacto@techosverdes.cdmx.gob.mx</span></li><li class="flex items-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" class="mt-0.5 h-4 w-4 shrink-0 text-white/40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2" ry="2"></rect><line x1="8" y1="21" x2="16" y2="21"></line><line x1="12" y1="17" x2="12" y2="21"></line></svg><span>Gobierno de la Ciudad de M\xE9xico</span></li></ul></div></div><div class="mt-10 border-t border-white/10 pt-6"><div class="flex items-center justify-center gap-6 mb-4"><a href="https://www.ciiemad.ipn.mx/" target="_blank" rel="noopener noreferrer"><img${ssrRenderAttr("src", _imports_0)} alt="CIIEMAD - IPN" class="h-14 w-auto rounded-full bg-white p-1"></a><a href="https://www.ipn.mx/" target="_blank" rel="noopener noreferrer"><img${ssrRenderAttr("src", _imports_1)} alt="Instituto Polit\xE9cnico Nacional" class="h-12 w-auto brightness-0 invert"></a></div><p class="text-center text-xs text-white/40"> \xA9 2024 Observatorio de Techos Verdes CDMX. Todos los derechos reservados. </p></div></div></footer>`);
    };
  }
});
...
//# sourceMappingURL=default-CpBC6kHM.mjs.map
