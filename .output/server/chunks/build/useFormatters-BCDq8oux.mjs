function useFormatters() {
  ...
  function formatArea(m2) {
    return `${numberFmt.format(m2)} m\xB2`;
  }
  ...
  function formatEstadoValidacion(estado) {
    ...
    const map = {
      ...
      pendiente_conciliacion: "Pend. conciliaci\xF3n"
    };
  ...
  function formatTipoEstructura(tipo) {
    ...
    const map = {
      ...
      acero: "Acero",
      mamposteria_confinada: "Mamposter\xEDa confinada",
      mamposteria_simple: "Mamposter\xEDa simple",
      lamina: "L\xE1mina",
      madera: "Madera",
      mixta: "Mixta",
  ...
  function formatEstadoEstructural(estado) {
    ...
    const map = {
      seguro: "Seguro",
      dano_menor: "Da\xF1o menor",
      dano_mayor: "Da\xF1o mayor",
  ...
  function formatMaterialTechumbre(material) {
    ...
    const map = {
      ...
      losacero: "Losacero",
      lamina_metalica: "L\xE1mina met\xE1lica",
      lamina_asbesto: "L\xE1mina asbesto",
  ...
  function formatNivelPrefactibilidad(nivel) {
    ...
    const map = {
      ...
      requiere_evaluacion: "Requiere evaluaci\xF3n",
...
//# sourceMappingURL=useFormatters-BCDq8oux.mjs.map
