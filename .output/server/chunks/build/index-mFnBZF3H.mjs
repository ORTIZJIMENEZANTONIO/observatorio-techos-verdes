    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_CommonHeroSection, { compact: "" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1 class="text-3xl font-extrabold text-white md:text-4xl"${_scopeId}>Metodolog\xEDa y aptitud territorial</h1><p class="mt-2 text-base text-white/80"${_scopeId}>Documentaci\xF3n t\xE9cnica del modelo multicriterio, variables, fuentes de datos y el \xEDndice de aptitud territorial</p>`);
          } else {
            return [
              createVNode("h1", { class: "text-3xl font-extrabold text-white md:text-4xl" }, "Metodolog\xEDa y aptitud territorial"),
              createVNode("p", { class: "mt-2 text-base text-white/80" }, "Documentaci\xF3n t\xE9cnica del modelo multicriterio, variables, fuentes de datos y el \xEDndice de aptitud territorial")
            ];
          }
        }),
        _: 1
...
//# sourceMappingURL=index-mFnBZF3H.mjs.map
